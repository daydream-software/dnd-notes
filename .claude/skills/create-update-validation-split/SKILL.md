...
description: "Use when defining request schemas for create and update routes — do not reuse the defaulted create schema for update or omitted fields will overwrite stored data."
metadata:
  version: 1.0.0
