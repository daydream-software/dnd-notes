...
- **Updated:** 2026-04-16T19:38:58Z
- **Active slice:** Issue #47 — web `App` integration spec split completed; API monolith split still in progress
...
- **Next likely task:** continue issue #47 by splitting `apps/api/test/app.test.ts` into feature-scoped API suites, then reassess whether #47 is done or whether to pivot to #45
