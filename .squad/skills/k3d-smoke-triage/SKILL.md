...
description: "Classify whether a failed k3d smoke run is an app regression or cluster/bootstrap fragility."
domain: "ci, k3d, github-actions"
confidence: "medium"
source: "earned"
tools:
  - name: "view"
    description: "Read smoke diagnostics artifacts such as control-plane logs, events, nodes, and resource listings."
    when: "After a smoke run uploads diagnostics."
  - name: "rg"
    description: "Search diagnostics for flannel, sandbox, image-pull, tenant, and readiness signals."
    when: "When narrowing the first failing layer."
---
